...
--
-- Host: localhost:8889
-- Generation Time: Feb 24, 2025 at 05:30 PM
...
(2, '2025-02-16 18:24:06', 4, 2, 'bilan podologique et orthèse plantaire', NULL, 110.00, 0, 0, 0),
(3, '2025-02-18 00:00:00', 4, 2, 'soin pédicure', 'OK', 36.00, 0, 0, 0),
(8, '2025-02-20 00:00:00', 4, 2, 'soin pédicure', 'OK', 36.00, 0, 0, 0),
(9, '2025-02-17 01:00:00', 4, 2, 'soin pédicure', 'OK', 36.00, 0, 0, 0),
(10, '2025-01-08 14:55:42', 1, 16, 'bilan podologique et orthèse plantaire', NULL, 150.00, 0, 0, 0),
(22, '2025-02-21 00:00:00', 4, 2, 'soin pédicure', NULL, 36.00, 0, 0, 1);
...
(29, 'mme', 'micke', 'rogera', '0789845780', NULL, NULL, 1, 16, 4, 6),
(30, 'm.', 'jiboli', 'pwapwa', '0789845780', 'test@tooken.fr', '$2b$10$Ag5kM1OE6svB0FrY.nCtmOa10TSXLFIeukmz2A.zb0hEdRxZttdPq', 0, NULL, NULL, NULL);
...
CREATE TABLE `guardian` (
  ...
  `token` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `guardian` (`id`, `customer_id`, `relationship`, `company`, `street`, `city`, `zip_code`, `token`) VALUES
(5, 16, 'société', 'gérance vieux', NULL, NULL, NULL, NULL),
(6, 1, 'société', 'test', '30 rue de brooklyn', 'new-york', '65005', NULL),
(11, 30, 'légal', NULL, '5 rue du test', 'paris', '75018', NULL);
